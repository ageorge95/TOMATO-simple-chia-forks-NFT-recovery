...
- The tool:
  ...
  - will also display the coins that are unqualified to be recovered (yet)
...
- Do not forget to join the Discord server dedicated for this tool: https://discord.gg/7SQfypERzc
